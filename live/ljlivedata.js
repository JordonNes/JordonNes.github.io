/* L&J LIVE DATA — CURRENT IN-GAME SNAPSHOT
   ...
   Snapshot: September 6, 2026 • 6:00 AM PT.
...
window.LJ_LIVE_DATA = (() => {
  ...
  const sports={
    MLB:empty("⚾","MLB","MLB.html","StatsHawk verifies zero MLB games in progress at this refresh. Sunday's slate has not entered a verified live state."),
    NFL:empty("🏈","NFL","NFL.html","StatsHawk verifies zero NFL games in progress at this refresh. Sunday games remain pregame/watch until independently verified live."),
    NBA:empty("🏀","NBA","NBA.html","No NBA game is independently verified in progress; NBA remains out of season."),
    WNBA:empty("🏀","WNBA","WNBA.html","No WNBA league game is independently verified in progress; league players are currently participating in FIBA competition."),
    ...
    FIBA_Women:empty("🌍🏀","FIBA WOMEN","FIBA_Women.html","No FIBA Women's World Cup game is independently verified in progress at this sweep. Türkiye–Australia is no longer carried as live. Official FIBA schedules Puerto Rico–Belgium next at 15:45 Berlin / 6:45 AM PT, so it remains WATCH/upcoming until verified in progress."),
    ...
    Tennis:empty("🎾","TENNIS","Tennis.html","U.S. Open Day 8 play is upcoming; no match is independently verified in progress at this refresh."),
  ...
  return {updated:"SEP 6, 2026 • 6:00 AM PT LIVE SNAPSHOT",nav,sports,statuses,home,W,MODEL};
})();