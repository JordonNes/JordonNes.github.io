...
window.LJ_LIVE_DATA = (() => {
  ...
  const sports = {
    MLB:empty("MLB","⚾","MLB","MLB.html","All September 4 MLB games checked at this sweep were final; September 5 games have not started."),
    ...
    FIBA_Women:empty("FIBA_Women","🌍🏀","FIBA WOMEN","FIBA_Women.html","September 4 Women's World Cup games are complete; September 5 group games begin later today."),
    NCAA_Football:empty("NCAA_Football","🏈","NCAA FOOTBALL","NCAA_Football.html","No September 4 NCAA Football contest remains in progress at the source sweep."),
    ...
    Tennis:empty("Tennis","🎾","TENNIS","Tennis.html","No current U.S. Open match was independently verified in progress at this overnight sweep."),
    UFC:empty("UFC","🥊","UFC","UFC.html","UFC Paris is later September 5; prelims begin 9:00 AM PT and the main card begins 12:00 PM PT."),
    Boxing:empty("Boxing","🥊","BOXING","Boxing.html","The September 4 Newark card is complete. Katie Taylor vs. Flora Pili at Croke Park is later September 5.")
  };
  ...
  const home = {
    ...
    description:"A separate live publication using the completed L&JDP information architecture without changing Daily Predictions. This sweep found no verified in-progress event across the monitored L&J sports, so stale September 4 live forecasts have been removed.",
    chips:[["NO LIVE EVENT NOW","purple"],["2-HOUR SOURCE SWEEP","gold"],["L&JDP ISOLATED","purple"]],
  ...
  return {updated:"SEP 5, 2026 • 12:00 AM PT LIVE SNAPSHOT",nav,sports,home,W};
})();
