/* LEGZ & JINX — L&J LIVE PREDICTIONS DATA
   ...
   Snapshot: September 5, 2026 • 12:00 AM PT.
   Verification sweep: StatsHawk live game status, current MLB schedule/results,
   official UFC Paris schedule, FIBA Women's World Cup schedule, current boxing
   schedules/results, and current U.S. Open reporting. No stale live data is retained. */
window.LJ_LIVE_DATA = (() => {
  ...
  const sports = {
    MLB:emptySport("⚾","MLB","All September 4 MLB games checked at the sweep were final; the September 5 slate has not started."),
    ...
    FIBA_Women:emptySport("🌍🏀","FIBA WOMEN","The September 4 Women's World Cup games are complete; September 5 group play begins later this morning."),
    NCAA_Football:emptySport("🏈","NCAA FOOTBALL","StatsHawk returned no NCAA Football contest in progress for the September 4 slate at this sweep."),
    NCAA_Basketball:emptySport("🏀","NCAA BASKETBALL","NCAA Basketball is out of season; no game is currently in progress."),
    Tennis:emptySport("🎾","TENNIS","No current U.S. Open match was independently verified in progress at this overnight source sweep."),
    UFC:emptySport("🥊","UFC","UFC Paris is scheduled for later September 5; prelims begin 9:00 AM PT and the main card 12:00 PM PT."),
    Boxing:emptySport("🥊","BOXING","The September 4 Newark card is complete. The Katie Taylor vs. Flora Pili Croke Park card begins later September 5.")
  };

  const statuses = [
    ["MLB","NO LIVE GAME","Sep 4 games final • Sep 5 slate begins later today"],
    ...
    ["FIBA_Women","NEXT TODAY","World Cup group play resumes later Sep 5"],
    ["NCAA_Football","NO LIVE GAME","No Sep 4 contest remains in progress"],
    ["NCAA_Basketball","NO LIVE GAME","Offseason"],
    ["Tennis","NO LIVE MATCH","U.S. Open overnight watch • no verified match in progress"],
  ...
  const home = {
    meta:"L&J LIVE • SEPTEMBER 5, 2026 • 12:00 AM PT",
    kicker:"L&J LIVE PREDICTIONS", title:"LEGZ & JINX — LIVE PREDICTIONS",
    description:"Separate live-game publication hub. This source sweep found no verified event currently in progress across the monitored L&J sports. Completed September 4 events have been removed from active-live presentation rather than carried forward as stale predictions.",
    chips:[["NO LIVE EVENT NOW","purple"],["2-HOUR SOURCE SWEEP","gold"],["SEPARATE FROM L&JDP","purple"]],
    hotTop:[], winners:[], twenty:[],
  ...
  return {updated:"Updated Sep 5, 2026 • 12:00 AM PT",nav,statuses,home,sports,WATCH};
})();
