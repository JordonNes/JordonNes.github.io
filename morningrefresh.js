...
(()=>{
 ...
 const n=D.sports.NFL;if(n){
   ...
   n.qcs=[{time:'SEP 14 • 5:15 PM PT / 8:15 PM ET',away:'DEN',home:'KC',market:'KC -2.5 • ML about -130 • O/U 43.5',winner:'Chiefs ML lean',conf:'55%',hot:['Mahomes U21.5 completions • 64%','Walker U61.5 rush yds • 62%','Nix O225.5 pass yds • 61%','Waddle 60+ rec yds • 58%','Mahomes 15+ rush yds • 56%','Nix 2+ pass TD • 54%'],sns1:['Mahomes U21.5 completions • 64%','Walker U61.5 rush yds • 62%','Nix O225.5 pass yds • 61%','Waddle 60+ rec yds • 58%','Mahomes 15+ rush yds • 56%','Nix 2+ pass TD • 54%'],sns2:['Mahomes U21.5 completions • 64%','Walker U61.5 rush yds • 62%','Nix O225.5 pass yds • 61%','Waddle 60+ rec yds • 58%','Mahomes 15+ rush yds • 56%','Nix 2+ pass TD • 54%'],normal:['Mahomes U21.5 completions • 64%','Walker U61.5 rush yds • 62%','Nix O225.5 pass yds • 61%','Waddle 60+ rec yds • 58%','Mahomes 15+ rush yds • 56%','Nix 2+ pass TD • 54%'],demon:['Nix 2+ pass TD • 54%','Waddle 60+ rec yds • 58%','Mahomes 15+ rush yds • 56%','Nix O225.5 pass yds • 61%','Walker U61.5 rush yds • 62%','Mahomes U21.5 completions • 64%'],foot:'9AM market. Recheck exact lines and final inactives/weather before entry.'}];
 }
